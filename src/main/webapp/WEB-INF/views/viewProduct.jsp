        ...
        <div class="container" ng-app = "cartApp">
            <div>
                ...
                <div class="col-md-5">
                    ...
                    <p><strong>Manufacturer</strong>:${product.productManufacturer.manufacturerName}</p>
                    <p><strong>Warehouse</strong>:${product.warehouse.warehouseName}</p>
                    ...
                    <p ng-controller="cartCtrl">
                        ...
                        <a href="#" class="btn btn-warning btn-large"
                           ng-click="addToCart('${product.productId}')">
                            <span class="glyphicon glyphicon-shopping-cart"></span>__Order Now
                        </a>
